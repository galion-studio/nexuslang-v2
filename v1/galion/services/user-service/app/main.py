"""
Main FastAPI application entry point for User Service.
...
app = FastAPI(
    ...
    version="1.0.0",
    description="Nexus Core User Service - Handles user profile management, search, and admin operations",
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=settings.ALLOWED_ORIGINS,  # ["http://localhost:3000"] for dev
...
if __name__ == "__main__":
    ...
    uvicorn.run(
        "app.main:app",
        host="0.0.0.0",
        port=8001,  # Different port from auth service (8000)
