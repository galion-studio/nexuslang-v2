...
from nexuslang.runtime.personality import (
    get_personality, set_personality, reset_personality,
    set_personality_template, mix_global_personality,
    get_personality_templates, evolve_global_personality,
    get_personality_profile, PersonalityManager
)
...
def get_ai_builtins() -> Dict[str, Callable]:
    ...
    return {
        ...
        'set_personality_template': set_personality_template,
        'mix_global_personality': mix_global_personality,
        'get_personality_templates': get_personality_templates,
        'evolve_global_personality': evolve_global_personality,
